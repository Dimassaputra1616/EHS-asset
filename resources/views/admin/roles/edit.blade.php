        ...
        <div class="card border-0 shadow-sm mt-3 animate-fade-in" style="border-radius: 20px; overflow: hidden;">
            <div class="card-header bg-white py-4 border-bottom-0 px-4">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h5 class="card-title mb-0 fw-bold" style="font-size: 1.2rem; color: #1e293b;">Edit Role</h5>
                ...
                <form action="{{ route('admin.roles.update', $role->id) }}" method="POST">
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            ...
                            <input type="text" name="name" class="form-control form-control-lg fs-6 @error('name') is-invalid @enderror" value="{{ old('name', $role->name) }}" required style="border-radius: 12px; background: #f8fafc; border: 1.5px solid #e2e8f0;">
                                                        ...
                                                        @foreach($groupPerms as $permission)
                                                            ...
                                                            <div class="col-md-6 col-lg-4">
                                                                <div class="form-check pwa-permission-check border bg-white p-3 rounded-3 h-100 d-flex align-items-start gap-2.5" style="cursor: pointer; border-radius: 12px !important;">
                                                                    <input class="form-check-input mt-1" type="checkbox" name="permission[]" value="{{ $permission->name }}" id="perm_{{ $permission->id }}"
                                                                        {{ in_array($permission->name, $rolePermissions) ? 'checked' : '' }} style="cursor: pointer; width: 1.15rem; height: 1.15rem;">
